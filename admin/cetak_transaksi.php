            ...
            <table  class="display table">
                ...
                <tbody>
                    ...
                    <tr style="margin-top:-15px;">
                        <td style="font-family: Verdana, Geneva, Tahoma, sans-serif; margin-top:-15px;"><?= $no++; ?></td>
                        <td style="font-family: Verdana, Geneva, Tahoma, sans-serif; margin-top:-15px;"><?= $t['pembayaran_kd']; ?></td>
                        <td style="font-family: Verdana, Geneva, Tahoma, sans-serif; margin-top:-15px;"><?= $t['pembayaran_waktu']; ?></td>
                        <td style="font-family: Verdana, Geneva, Tahoma, sans-serif; margin-top:-15px;"><?= 'Rp ' .  number_format($t['pembayaran_final'], 0, ".", ",")?></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr>
