			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item <?php if($Title=='Data Master'){echo 'active submenu';} ?>">
							<a data-toggle="collapse" href="#master">
								<i class="fas fa-book"></i>
								<p>Data Master</p>
								<span class="caret"></span>
							</a>
							<div class="collapse <?php if($Title=='Data Master'){echo 'show';} ?>" id="master">
								<ul class="nav nav-collapse">
									<li class="<?php if($title=='Data Outlet'){echo 'active';} ?>">
										<a href="outlet.php">
											<span class="sub-item">Data Outlet</span>
										</a>
									</li>
									<li class="<?php if($title=='Data Service'){echo 'active';} ?>">
										<a href="service.php">
											<span class="sub-item">Data Service</span>
										</a>
									</li>
									<li class="<?php if($title=='Data Pelanggan'){echo 'active';} ?>">
										<a href="pelanggan.php">
											<span class="sub-item">Data Pelanggan</span>
										</a>
									</li>
									<li class="<?php if($title=='Data Pengguna'){echo 'active';} ?>">
										<a href="pengguna.php">
